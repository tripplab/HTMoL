...
var WebIP="127.0.0.1"; // Server Name or IP. Use 'localhost' for testing
var NodePort="3000"; // Define internet port for comunication, other than 80 (reserved for Apache)
